...
\usepackage{verbatim}							% para poder meter comentarios en el codigo latex
...
\usepackage[
	...
	\graphicspath{{images/}}
% ----------------- Configuracion de xcolor ------------- %
%\definecolor{mintedbackground}{RGB}{25, 25, 25}
...
\hypersetup{								
	...
	\rfoot{Página \thepage}
	\cfoot{\includegraphics[width=0.3in]{logo}}
	\lfoot{Krapp Ramiro}
...
\subfile{subfiles/pcb.tex}
\subfile{subfiles/partes-proyecto.tex}
\subfile{subfiles/diseno-3d.tex}
{
	\subfile{subfiles/frameworks.tex}
}
{
	\renewcommand{\subsectionbreak}{}
	\subfile{subfiles/protocolos-comunicacion.tex}
}
